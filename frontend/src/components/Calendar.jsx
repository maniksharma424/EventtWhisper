  ...
  return (
    <div className="w-full sm:h-[1100px]  font-calendar">
      <div className="w-full sm:h-36 flex justify-center items-center">
        <h1 className="sm:text-[40px] text-[25px] sm:mt-0 mt-5 font-[500]">Calendar</h1>
      </div>
      <div id="calendar-bar" className=" w-full sm:py-2 py-1 flex justify-between items-center">
        ...
        <div id="total-notifications" className="sm:w-1/4 w-1/3 h-12 flex justify-center py-2 sm:text-[18px] text-[12px]  ">
      ...
      <ul id="calendar-days" className="flex  justify-between mt-4 sm:px-28  w-full">
        {weekdays.map((day) => (
      ...
      <ul id="calendar-dates" className="flex flex-wrap  h-fit mt-4 sm:px-28 font-[600] ">
        {emptyDays.map((day) => (
          <li
            key={`previous_${day}`}
